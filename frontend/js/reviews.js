      ...
      <div class="card" id="paper-${paper._id}" style="margin-bottom: 20px;">
        <div class="card-header" style="padding-bottom: 0;">
          <div style="display: flex; justify-content: space-between; align-items: flex-start; width: 100%;">
            ...
            <span class="badge ${statusClass}">${(paper.status || 'pending').replace('_', ' ').toUpperCase()}</span>
          </div>
        </div>
        <div class="card-body" style="padding-top: 12px;">
          ...
          <p style="margin-bottom: 20px; line-height: 1.5; color: var(--text-secondary);">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--border-light); padding-top: 16px;">
            ${isReviewed ? `
              <div>
                ...
                <span style="font-size: 14px; color: var(--text-secondary); margin-left: 12px;">Recommendation: <strong>${paper.reviewDecision || 'N/A'}</strong></span>
              </div>
            ` : `
              <div>
